...
[`ks`](http://www.mvstat.net/mvksa/) supports boundary correction through the `kde.boundary` function, while [`Ake`](https://cran.r-project.org/web/packages/Ake/index.html) corrects for 
...
used as any density functon in `R` (such as `stats::dnorm`). For example, you can
do:
