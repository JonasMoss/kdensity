...
from [Hallberg Szabadváry's *A Fast, Closed-Form Bandwidth Selector for the Beta Kernel Density Estimator* (2026)](https://arxiv.org/abs/2601.19553).
It is much faster than the previous `"ucv"` default.
...
```{r beta-kernel-example, echo = TRUE}
set.seed(42)
...
* [Hallberg Szabadváry, Johan. "A Fast, Closed-Form Bandwidth Selector for the Beta Kernel Density Estimator." arXiv preprint arXiv:2601.19553 (2026).](https://arxiv.org/abs/2601.19553)
