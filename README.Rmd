...
For the bias-corrected `beta` kernel with a uniform or constant start, `kdensity`
now defaults to the closed-form `beta_rot` bandwidth selector based on
Hallberg Szabadváry's beta reference rule.
