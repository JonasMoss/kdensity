...
Kernel density estimation with a parametric start was introduced by Nils Lid Hjort and Ingrid Glad in their 1996 paper [Nonparametric Density Estimation with a Parametric Start](https://projecteuclid.org/euclid.aos/1176324627). The idea is to start out with a parametric density before you do your kernel density estimation, so that your actual kernel density estimation will be a correction to the original parametric estimate. Why is this a good idea? Because the resulting estimator will be better than a naïve kernel density estimator whenever the true density is close to your suggestion, and probably not worse if not. Read the paper for more information.
